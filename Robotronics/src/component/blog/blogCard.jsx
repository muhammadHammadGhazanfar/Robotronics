  ...
  return (
    <div className="lg:max-w-[25vw] max-w-sm rounded overflow-hidden shadow-lg bg-white">
      ...
      <div className="px-6 py-4">
        <div className="font-bold text-wrap poppins-bold text-xl mb-2">{cardData.title}</div>
        <p className="text-gray-700 text-wrap poppins-light x text-base">{cardData.description}</p>
      </div>
      <div className="px-6 pt-4 pb-2 flex flex-col justify-between">
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex flex-row items-center " >
            <img className="w-10 h-10 rounded-full mr-4"
              ...
              alt="Author"
            />
            <p className="text-gray-900 leading-none poppins-light ">{cardData.author.name}</p>
          </div>
        ...
        <div className="flex flex-wrap items-center  justify-between">
          ...
          <div className="flex flex-row  items-center" >
            <FaShareAlt />
            <span className="text-gray-600 poppins-light px-1 ">{cardData.shares} shares</span>
          </div>
        </div>
      </div>
    </div>
